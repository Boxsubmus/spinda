 ...
 */
final class Version20260717033503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `group` (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, roles JSON NOT NULL, color VARCHAR(6) NOT NULL, display_name VARCHAR(50) NOT NULL, UNIQUE INDEX UNIQ_NAME (name), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
